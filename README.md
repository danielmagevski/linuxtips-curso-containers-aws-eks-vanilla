...
| [kubectl_manifest.gp3](https://registry.terraform.io/providers/gavinbunney/kubectl/1.18.0/docs/resources/manifest) | resource |
...
| <a name="input_addon_ebs_csi_version"></a> [addon\_ebs\_csi\_version](#input\_addon\_ebs\_csi\_version) | Versão do Addon do EBS CSI | `string` | `"v1.39.0-eksbuild.1"` | no |
...
| <a name="input_addon_s3_csi_version"></a> [addon\_s3\_csi\_version](#input\_addon\_s3\_csi\_version) | Versão do Addon do S3 CSI | `string` | `"v1.11.0-eksbuild.1"` | no |
